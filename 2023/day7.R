...
df2 <- df %>% mutate(
  ...
  new_hand = case_when(
    ...
    (c1==1 | c2==1 | c3==1 | c4==1 | c5==1) & hand==4 ~ 6,
    (c1==1 | c2==1 | c3==1 | c4==1 | c5==1) & hand==3 & j!=2 ~ 5,
    (c1==1 | c2==1 | c3==1 | c4==1 | c5==1) & hand==3 & j==2 ~ 6,
    (c1==1 | c2==1 | c3==1 | c4==1 | c5==1) & hand==2 ~ 4,
...
# df2 %>% filter((c1==1 | c2==1 | c3==1 | c4==1 | c5==1) & hand==6) %>% View() # change 4 of a kind to hand 7 
# df2 %>% filter((c1==1 | c2==1 | c3==1 | c4==1 | c5==1) & hand==5) %>% View() # change full house to hand 7
# df2 %>% filter((c1==1 | c2==1 | c3==1 | c4==1 | c5==1) & hand==4) %>% View() # change 3 of kind to hand 6
# df2 %>% filter((c1==1 | c2==1 | c3==1 | c4==1 | c5==1) & hand==3) %>% View() # change 2 pair to hand 5 (full house) unless there are 2 jokers, then change to hand 6
# df2 %>% filter((c1==1 | c2==1 | c3==1 | c4==1 | c5==1) & hand==2) %>% View() # change pair to hand 4 
# df2 %>% filter((c1==1 | c2==1 | c3==1 | c4==1 | c5==1) & hand==1) %>% View() # change high card to hand 2
